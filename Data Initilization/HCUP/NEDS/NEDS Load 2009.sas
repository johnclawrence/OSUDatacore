...
* INFILE "%trim(&filepath)NEDS/NEDS_2009/Data/NEDS_2009_   *;  
...
/*****************************************************************************
 * SASload_NEDS_2009_Hospital.SAS
 * This program will load the 2009 NEDS csv Hospital File into SAS.
 *****************************************************************************/
...
DATA NEDS_2009_Hospital; 
INFILE "%trim(&filepath)NEDS/NEDS_2009/Data/NEDS_2009_Hospital.csv" dsd dlm=',' LRECL = 95;                                                                                                                                                                                                     
...
RUN;
/*****************************************************************************
 * SASload_NEDS_2009_IP.SAS
 * This program will load the 2009 NEDS csv IP File into SAS.
 *****************************************************************************/
...
/* Data Step to load the file */
DATA NEDS_2009_IP; 
INFILE "%trim(&filepath)NEDS/NEDS_2009/Data/NEDS_2009_IP.csv" dsd dlm=',' LRECL = 200;                                                                                                                                                                                                    
...
RUN;
/*****************************************************************************
 * SASload_NEDS_2009_Core.SAS
 * This program will load the 2009 NEDS csv Core File into SAS.
 *****************************************************************************/
...
/* Data Step to load the file */
DATA NEDS_2009_Core; 
INFILE "%trim(&filepath)NEDS/NEDS_2009/Data/NEDS_2009_Core.csv" dsd dlm=',' LRECL = 418;                                                                                                                                                                                                    
...
RUN;
/*****************************************************************************
 * SASload_NEDS_2009_ED.SAS
 * This program will load the 2009 NEDS csv ED File into SAS.
 *****************************************************************************/
...
/* Data Step to load the file */
DATA NEDS_2009_ED; 
INFILE "%trim(&filepath)NEDS/NEDS_2009/Data/NEDS_2009_ED.csv" dsd dlm=',' LRECL = 331;                                                                                                                                                                                                    
...
proc SQL;
create table isilon.NEDS_2009_Core
like work.NEDS_2009_Core;

proc SQL;
insert into isilon.NEDS_2009_Core
select * from work.NEDS_2009_Core;

proc SQL;
create table isilon.NEDS_2009_IP
like work.NEDS_2009_IP;

proc SQL;
insert into isilon.NEDS_2009_IP
select * from work.NEDS_2009_IP;

proc SQL;
create table isilon.NEDS_2009_ED
like work.NEDS_2009_ED;

proc SQL;
insert into isilon.NEDS_2009_ED
select * from work.NEDS_2009_ED;

proc SQL;
create table isilon.NEDS_2009_Hospital
like work.NEDS_2009_Hospital;

proc SQL;
insert into isilon.NEDS_2009_Hospital
select * from work.NEDS_2009_Hospital;



proc delete data= work.NEDS_2009_Core; run;
proc delete data= work.NEDS_2009_IP; run;
proc delete data= work.NEDS_2009_ED; run;
proc delete data= work.NEDS_2009_Hospital; run;