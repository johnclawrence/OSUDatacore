...
* "%trim(&filepath)NEDS/NEDS_2014/Data/NEDS_2014_   *;  
...
/*****************************************************************************
 * SASload_NEDS_2014_Hospital.SAS
 * This program will load the 2014 NEDS csv Hospital File into SAS.
 *****************************************************************************/
...
DATA NEDS_2014_Hospital; 
INFILE "%trim(&filepath)NEDS/NEDS_2014/Data/NEDS_2014_Hospital.csv" dsd dlm=',' LRECL = 95;
...
RUN;
/*****************************************************************************
 * SASload_NEDS_2014_IP.SAS
 * This program will load the 2014 NEDS csv IP File into SAS.
 *****************************************************************************/
...
/* Data Step to load the file */
DATA NEDS_2014_IP; 
INFILE "%trim(&filepath)NEDS/NEDS_2014/Data/NEDS_2014_IP.csv" dsd dlm=',' LRECL = 201;
...
RUN;
/*****************************************************************************
 * SASload_NEDS_2014_Core.SAS
 * This program will load the 2014 NEDS csv Core File into SAS.
 *****************************************************************************/
...
/* Data Step to load the file */
DATA NEDS_2014_Core; 
INFILE "%trim(&filepath)NEDS/NEDS_2014/Data/NEDS_2014_Core.csv" dsd dlm=',' LRECL = 625;
...
RUN;
/*****************************************************************************
 * SASload_NEDS_2014_ED.SAS
 * This program will load the 2014 NEDS csv ED File into SAS.
 *****************************************************************************/
...
/* Data Step to load the file */
DATA NEDS_2014_ED; 
INFILE "%trim(&filepath)NEDS/NEDS_2014/Data/NEDS_2014_ED.csv" dsd dlm=',' LRECL = 332;
...
proc SQL;
create table isilon.NEDS_2014_Core
like work.NEDS_2014_Core;

proc SQL;
insert into isilon.NEDS_2014_Core
select * from work.NEDS_2014_Core;

proc SQL;
create table isilon.NEDS_2014_IP
like work.NEDS_2014_IP;

proc SQL;
insert into isilon.NEDS_2014_IP
select * from work.NEDS_2014_IP;

proc SQL;
create table isilon.NEDS_2014_ED
like work.NEDS_2014_ED;

proc SQL;
insert into isilon.NEDS_2014_ED
select * from work.NEDS_2014_ED;

proc SQL;
create table isilon.NEDS_2014_Hospital
like work.NEDS_2014_Hospital;

proc SQL;
insert into isilon.NEDS_2014_Hospital
select * from work.NEDS_2014_Hospital;



proc delete data= work.NEDS_2014_Core; run;
proc delete data= work.NEDS_2014_IP; run;
proc delete data= work.NEDS_2014_ED; run;
proc delete data= work.NEDS_2014_Hospital; run;