...
* INFILE "%trim(&filepath)NEDS/NEDS_2010/Data/NEDS_2010_   *;  
...
/*****************************************************************************
 * SASload_NEDS_2010_Hospital.SAS
 * This program will load the 2010 NEDS csv Hospital File into SAS.
 *****************************************************************************/
...
DATA NEDS_2010_Hospital; 
INFILE "%trim(&filepath)NEDS/NEDS_2010/Data/NEDS_2010_Hospital.csv" dsd dlm=',' LRECL = 95;                                                                                                                                                                                                     
...
RUN;
/*****************************************************************************
 * SASload_NEDS_2010_IP.SAS
 * This program will load the 2010 NEDS csv IP File into SAS.
 *****************************************************************************/
...
/* Data Step to load the file */
DATA NEDS_2010_IP; 
INFILE "%trim(&filepath)NEDS/NEDS_2010/Data/NEDS_2010_IP.csv" dsd dlm=',' LRECL = 200;                                                                                                                                                                                                    
...
RUN;
/*****************************************************************************
 * SASload_NEDS_2010_Core.SAS
 * This program will load the 2010 NEDS csv Core File into SAS.
 *****************************************************************************/
...
/* Data Step to load the file */
DATA NEDS_2010_Core; 
INFILE "%trim(&filepath)NEDS/NEDS_2010/Data/NEDS_2010_Core.csv" dsd dlm=',' LRECL = 418;                                                                                                                                                                                                    
...
/*****************************************************************************
 * SASload_NEDS_2010_ED.SAS
 * This program will load the 2010 NEDS csv ED File into SAS.
 *****************************************************************************/
...
/* Data Step to load the file */
DATA NEDS_2010_ED; 
INFILE "%trim(&filepath)NEDS/NEDS_2010/Data/NEDS_2010_ED.csv" dsd dlm=',' LRECL = 331;                                                                                                                                                                                                    
...
proc SQL;
create table isilon.NEDS_2010_Core
like work.NEDS_2010_Core;

proc SQL;
insert into isilon.NEDS_2010_Core
select * from work.NEDS_2010_Core;

proc SQL;
create table isilon.NEDS_2010_IP
like work.NEDS_2010_IP;

proc SQL;
insert into isilon.NEDS_2010_IP
select * from work.NEDS_2010_IP;

proc SQL;
create table isilon.NEDS_2010_ED
like work.NEDS_2010_ED;

proc SQL;
insert into isilon.NEDS_2010_ED
select * from work.NEDS_2010_ED;

proc SQL;
create table isilon.NEDS_2010_Hospital
like work.NEDS_2010_Hospital;

proc SQL;
insert into isilon.NEDS_2010_Hospital
select * from work.NEDS_2010_Hospital;



proc delete data= work.NEDS_2010_Core; run;
proc delete data= work.NEDS_2010_IP; run;
proc delete data= work.NEDS_2010_ED; run;
proc delete data= work.NEDS_2010_Hospital; run;