...
* INFILE "%trim(&filepath)NEDS/NEDS_2008/Data/NEDS_2008_   *;  
...
/*****************************************************************************
 * SASload_NEDS_2008_Hospital.SAS
 * This program will load the 2008 NEDS csv Hospital File into SAS.
 *****************************************************************************/
...
DATA NEDS_2008_Hospital; 
INFILE "%trim(&filepath)NEDS/NEDS_2008/Data/NEDS_2008_Hospital.csv" dsd dlm=',' LRECL = 95;                                                                                                                                                                                                     
...
RUN;
/*****************************************************************************
 * SASload_NEDS_2008_ED.SAS
 * This program will load the 2008 NEDS csv ED File into SAS.
 *****************************************************************************/
...
/* Data Step to load the file */
DATA NEDS_2008_ED; 
INFILE "%trim(&filepath)NEDS/NEDS_2008/Data/NEDS_2008_ED.csv" dsd dlm=',' LRECL = 331;                                                                                                                                                                                                    
...
RUN;
/*****************************************************************************
 * SASload_NEDS_2008_Core.SAS
 * This program will load the 2008 NEDS csv Core File into SAS.
 *****************************************************************************/
...
/* Data Step to load the file */
DATA NEDS_2008_Core; 
INFILE "%trim(&filepath)NEDS/NEDS_2008/Data/NEDS_2008_Core.csv" dsd dlm=',' LRECL = 385;                                                                                                                                                                                                    
...
RUN;
/*****************************************************************************
 * SASload_NEDS_2008_IP.SAS
 * This program will load the 2008 NEDS csv IP File into SAS.
 *****************************************************************************/
...
/* Data Step to load the file */
DATA NEDS_2008_IP; 
INFILE "%trim(&filepath)NEDS/NEDS_2008/Data/NEDS_2008_IP.csv" dsd dlm=',' LRECL = 197;                                                                                                                                                                                                    
...
proc SQL;
create table isilon.NEDS_2008_Core
like work.NEDS_2008_Core;

proc SQL;
insert into isilon.NEDS_2008_Core
select * from work.NEDS_2008_Core;

proc SQL;
create table isilon.NEDS_2008_IP
like work.NEDS_2008_IP;

proc SQL;
insert into isilon.NEDS_2008_IP
select * from work.NEDS_2008_IP;

proc SQL;
create table isilon.NEDS_2008_ED
like work.NEDS_2008_ED;

proc SQL;
insert into isilon.NEDS_2008_ED
select * from work.NEDS_2008_ED;

proc SQL;
create table isilon.NEDS_2008_Hospital
like work.NEDS_2008_Hospital;

proc SQL;
insert into isilon.NEDS_2008_Hospital
select * from work.NEDS_2008_Hospital;



proc delete data= work.NEDS_2008_Core; run;
proc delete data= work.NEDS_2008_IP; run;
proc delete data= work.NEDS_2008_ED; run;
proc delete data= work.NEDS_2008_Hospital; run;