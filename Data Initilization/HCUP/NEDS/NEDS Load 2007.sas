...
* "%trim(&filepath)NEDS/NEDS_2007/Data/NEDS_2007_   *;  
...
/*****************************************************************************
* SASload_NEDS_2007_Hospital.SAS
* This program will load the 2007 NEDS csv Hospital File into SAS.
*****************************************************************************/
...
DATA NEDS_2007_Hospital; 
"%trim(&filepath)NEDS/NEDS_2007/Data/NEDS_2007_Hospital.csv" dsd dlm=',' LRECL = 96;                                                                                                                                                                                                     
...
RUN;
/*****************************************************************************
* SASload_NEDS_2007_ED.SAS
* This program will load the 2007 NEDS csv ED File into SAS.
*****************************************************************************/
...
*** Data Step to load the file ***;
DATA NEDS_2007_ED; 
"%trim(&filepath)NEDS/NEDS_2007/Data/NEDS_2007_ED.csv" dsd dlm=',' LRECL = 256;                                                                                                                                                                                                    
...
RUN;
/*****************************************************************************
* SASload_NEDS_2007_Core.SAS
* This program will load the 2007 NEDS csv Core File into SAS.
*****************************************************************************/
...
*** Data Step to load the file ***;
DATA NEDS_2007_Core; 
"%trim(&filepath)NEDS/NEDS_2007/Data/NEDS_2007_Core.csv" dsd dlm=',' LRECL = 386;                                                                                                                                                                                                    
...
*** Data Step to load the file ***;
DATA NEDS_2007_IP; 
"%trim(&filepath)NEDS/NEDS_2007/Data/NEDS_2007_IP.csv" dsd dlm=',' LRECL = 194;                                                                                                                                                                                                    
