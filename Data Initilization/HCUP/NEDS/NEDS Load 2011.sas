...
* INFILE "%trim(&filepath)NEDS/NEDS_2011/Data/NEDS_2011_   *;  
...
/*****************************************************************************
 * SASload_NEDS_2011_IP.SAS
 * This program will load the 2011 NEDS csv IP File into SAS.
 *****************************************************************************/
...
DATA NEDS_2011_IP; 
INFILE "%trim(&filepath)NEDS/NEDS_2011/Data/NEDS_2011_IP.csv" dsd dlm=',' LRECL = 183;                                                                                                                                                                                                    
...
RUN;
/*****************************************************************************
 * SASload_NEDS_2011_Core.SAS
 * This program will load the 2011 NEDS csv Core File into SAS.
 *****************************************************************************/
...
/* Data Step to load the file */
DATA NEDS_2011_Core; 
INFILE "%trim(&filepath)NEDS/NEDS_2011/Data/NEDS_2011_Core.csv" dsd dlm=',' LRECL = 415;                                                                                                                                                                                                    
...
RUN;
/*****************************************************************************
 * SASload_NEDS_2011_ED.SAS
 * This program will load the 2011 NEDS csv ED File into SAS.
 *****************************************************************************/
...
/* Data Step to load the file */
DATA NEDS_2011_ED; 
INFILE "%trim(&filepath)NEDS/NEDS_2011/Data/NEDS_2011_ED.csv" dsd dlm=',' LRECL = 314;                                                                                                                                                                                                    
...
RUN;
/*****************************************************************************
 * SASload_NEDS_2011_Hospital.SAS
 * This program will load the 2011 NEDS csv Hospital File into SAS.
 *****************************************************************************/
...
/* Data Step to load the file */
DATA NEDS_2011_Hospital; 
INFILE "%trim(&filepath)NEDS/NEDS_2011/Data/NEDS_2011_Hospital.csv" dsd dlm=',' LRECL = 95;                                                                                                                                                                                                     
...
proc SQL;
create table isilon.NEDS_2011_Core
like work.NEDS_2011_Core;

proc SQL;
insert into isilon.NEDS_2011_Core
select * from work.NEDS_2011_Core;

proc SQL;
create table isilon.NEDS_2011_IP
like work.NEDS_2011_IP;

proc SQL;
insert into isilon.NEDS_2011_IP
select * from work.NEDS_2011_IP;

proc SQL;
create table isilon.NEDS_2011_ED
like work.NEDS_2011_ED;

proc SQL;
insert into isilon.NEDS_2011_ED
select * from work.NEDS_2011_ED;

proc SQL;
create table isilon.NEDS_2011_Hospital
like work.NEDS_2011_Hospital;

proc SQL;
insert into isilon.NEDS_2011_Hospital
select * from work.NEDS_2011_Hospital;



proc delete data= work.NEDS_2011_Core; run;
proc delete data= work.NEDS_2011_IP; run;
proc delete data= work.NEDS_2011_ED; run;
proc delete data= work.NEDS_2011_Hospital; run;