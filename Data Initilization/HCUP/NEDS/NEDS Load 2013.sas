...
* INFILE "%trim(&filepath)NEDS/NEDS_2013/Data/NEDS_2013_   *;  
...
/*****************************************************************************
 * SASload_NEDS_2013_ED.SAS
 * This program will load the 2013 NEDS csv ED File into SAS.
 *****************************************************************************/
...
DATA NEDS_2013_ED; 
INFILE "%trim(&filepath)NEDS/NEDS_2013/Data/NEDS_2013_ED.csv" dsd dlm=',' LRECL = 332;
...
RUN;
/*****************************************************************************
 * SASload_NEDS_2013_Hospital.SAS
 * This program will load the 2013 NEDS csv Hospital File into SAS.
 *****************************************************************************/
...
/* Data Step to load the file */
DATA NEDS_2013_Hospital; 
INFILE "%trim(&filepath)NEDS/NEDS_2013/Data/NEDS_2013_Hospital.csv" dsd dlm=',' LRECL = 95;
...
RUN;
/*****************************************************************************
 * SASload_NEDS_2013_IP.SAS
 * This program will load the 2013 NEDS csv IP File into SAS.
 *****************************************************************************/
...
/* Data Step to load the file */
DATA NEDS_2013_IP; 
INFILE "%trim(&filepath)NEDS/NEDS_2013/Data/NEDS_2013_IP.csv" dsd dlm=',' LRECL = 201;
...
RUN;
/*****************************************************************************
 * SASload_NEDS_2013_Core.SAS
 * This program will load the 2013 NEDS csv Core File into SAS.
 *****************************************************************************/
...
/* Data Step to load the file */
DATA NEDS_2013_Core; 
INFILE "%trim(&filepath)NEDS/NEDS_2013/Data/NEDS_2013_Core.csv" dsd dlm=',' LRECL = 415;
...
proc SQL;
create table isilon.NEDS_2013_Core
like work.NEDS_2013_Core;

proc SQL;
insert into isilon.NEDS_2013_Core
select * from work.NEDS_2013_Core;

proc SQL;
create table isilon.NEDS_2013_IP
like work.NEDS_2013_IP;

proc SQL;
insert into isilon.NEDS_2013_IP
select * from work.NEDS_2013_IP;

proc SQL;
create table isilon.NEDS_2013_ED
like work.NEDS_2013_ED;

proc SQL;
insert into isilon.NEDS_2013_ED
select * from work.NEDS_2013_ED;

proc SQL;
create table isilon.NEDS_2013_Hospital
like work.NEDS_2013_Hospital;

proc SQL;
insert into isilon.NEDS_2013_Hospital
select * from work.NEDS_2013_Hospital;



proc delete data= work.NEDS_2013_Core; run;
proc delete data= work.NEDS_2013_IP; run;
proc delete data= work.NEDS_2013_ED; run;
proc delete data= work.NEDS_2013_Hospital; run;