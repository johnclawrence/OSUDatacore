...
* "%trim(&filepath)NIS/NIS_2006/Data/NIS_2006   *;  
...
INFILE "%trim(&filepath)NIS/NIS_2006/Data/NIS_2006_Dx_Pr_Grps.asc" LRECL = 271;                                                                                                                                                                                                    
...
RUN;
/*****************************************************************************
* SASload_NIS_2006_Core.SAS
* This program will load the 2006 NIS ASCII Core File into SAS.
*****************************************************************************/
...
*** Data Step to load the file ***;
DATA NIS_2006_Core; 
INFILE "%trim(&filepath)NIS/NIS_2006/Data/NIS_2006_Core.asc" LRECL = 510;                                                                                                                                                                                                    
...
INPUT 
      ...
      @490    TOTCHG_X                 N15P2F.
      @505    YEAR                     N4PF.
      @509    ZIPINC_QRTL              N2PF.
      ;
RUN;
/*****************************************************************************
* SASload_NIS_2006_Severity.SAS
* This program will load the 2006 NIS ASCII Severity File into SAS.
*****************************************************************************/
...
*** Data Step to load the file ***;
DATA NIS_2006_Severity; 
INFILE "%trim(&filepath)NIS/NIS_2006/Data/NIS_2006_Severity.asc" LRECL = 172;                                                                                                                                                                                                    
...
RUN;
/*****************************************************************************
* SASload_NIS_2006_Hospital.SAS
* This program will load the 2006 NIS ASCII Hospital File into SAS.
*****************************************************************************/
...
*** Data Step to load the file ***;
DATA NIS_2006_Hospital; 
INFILE "%trim(&filepath)NIS/NIS_2006/Data/NIS_2006_Hospital.asc" LRECL = 185;                                                                                                                                                                                                    
...
proc SQL;
create table isilon.NIS_2006_HOSPITAL
like work.NIS_2006_HOSPITAL;

proc SQL;
insert into isilon.NIS_2006_HOSPITAL
select * from work.NIS_2006_HOSPITAL;

proc SQL;
create table isilon.NIS_2006_CORE
like work.NIS_2006_CORE;

proc SQL;
insert into isilon.NIS_2006_CORE
select * from work.NIS_2006_CORE;

proc SQL;
create table isilon.NIS_2006_Dx_Pr_Grps
like work.NIS_2006_Dx_Pr_Grps;

proc SQL;
insert into isilon.NIS_2006_Dx_Pr_Grps
select * from work.NIS_2006_Dx_Pr_Grps;

proc SQL;
create table isilon.NIS_2006_SEVERITY
like work.NIS_2006_SEVERITY;

proc SQL;
insert into isilon.NIS_2006_SEVERITY
select * from work.NIS_2006_SEVERITY;



proc delete data= work.NIS_2006_HOSPITAL; run;
proc delete data= work.NIS_2006_CORE; run;
proc delete data= work.NIS_2006_Dx_Pr_Grps; run;
proc delete data= work.NIS_2006_SEVERITY; run;