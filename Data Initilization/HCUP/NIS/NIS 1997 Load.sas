...
* "%trim(&filepath)NIS/NIS_1997/Data/NIS97   *;  
...
***********************************************;
DATA NIS_1997_A;
  INFILE "%trim(&filepath)NIS/NIS_1997/Data/NIS97_A.ASC" LRECL=95;
  ...
  *** Labels for the variables in File A ***;
  LABEL
      ...
      RACE    ='I:Race'
      SEQ     ='I:HCUP record sequence number'
      SEX     ='I:Sex'
  ...
  *** Minor correction for input file;
  IF PR1='.' THEN PR1=' ';
...
***********************************************;
DATA NIS_1997_B;
  INFILE "%trim(&filepath)NIS/NIS_1997/Data/NIS97_B.ASC" LRECL=91;
  ...
  *** Minor correction to ASCII;

  If SURGID_S='.' then SURGID_S=' ';
...
***********************************************;
DATA NIS_1997_C;
  INFILE "%trim(&filepath)NIS/NIS_1997/Data/NIS97_C.ASC" LRECL=65;
...
*                  THE ASCII NIS CORE FILE DX (DIAGNOSES)  ;
*                  TO SAS.                                 ;
*                                                          ;
***********************************************************;
...
***********************************************;
DATA NIS_1997_DX;
  INFILE "%trim(&filepath)NIS/NIS_1997/Data/NIS97_DX.ASC" LRECL=20;
...
*                  THE ASCII NIS CORE FILE PR (PROCEDURES) ;
*                  TO SAS.                                 ;
*                                                          ;
***********************************************************;
...
***********************************************;
DATA NIS_1997_PR;
  INFILE "%trim(&filepath)NIS/NIS_1997/Data/NIS97_PR.ASC" LRECL=19;
...
***********************************************;
DATA NIS_1997_CMDRG;
  INFILE "%trim(&filepath)NIS/NIS_1997/Data/N97_HDRG.ASC" LRECL=46;
...
*  Data step                                   ;
***********************************************;
DATA NIS_1997_CMPCCHPR1;
  INFILE "%trim(&filepath)NIS/NIS_1997/Data/N97_HPC1.ASC" LRECL=46;
...
*  Data step                                   ;
***********************************************;
DATA NIS_1997_CMDCCHPR1;
  INFILE "%trim(&filepath)NIS/NIS_1997/Data/N97_HDC1.ASC" LRECL=46;
...
DATA NIS_1997_WT;
  INFILE "%trim(&filepath)NIS/NIS_1997/Data/NIS97WT.ASC" LRECL=251;
...
proc SQL;
create table isilon.NIS_1997_C
like work.NIS_1997_C;

proc SQL;
insert into isilon.NIS_1997_C
select * from work.NIS_1997_C;

proc SQL;
create table isilon.NIS_1997_B
like work.NIS_1997_B;

proc SQL;
insert into isilon.NIS_1997_B
select * from work.NIS_1997_B;

proc SQL;
create table isilon.NIS_1997_A
like work.NIS_1997_A;

proc SQL;
insert into isilon.NIS_1997_A
select * from work.NIS_1997_A;

proc SQL;
create table isilon.NIS_1997_PR
like work.NIS_1997_PR;

proc SQL;
insert into isilon.NIS_1997_PR
select * from work.NIS_1997_PR;

proc SQL;
create table isilon.NIS_1997_DX
like work.NIS_1997_DX;

proc SQL;
insert into isilon.NIS_1997_DX
select * from work.NIS_1997_DX;

proc SQL;
create table isilon.NIS_1997_WT
like work.NIS_1997_WT;

proc SQL;
insert into isilon.NIS_1997_WT
select * from work.NIS_1997_WT;

proc SQL;
create table isilon.NIS_1997_CMDRG
like work.NIS_1997_CMDRG;

proc SQL;
insert into isilon.NIS_1997_CMDRG
select * from work.NIS_1997_CMDRG;

proc SQL;
create table isilon.NIS_1997_CMDCCHPR1
like work.NIS_1997_CMDCCHPR1;

proc SQL;
insert into isilon.NIS_1997_CMDCCHPR1
select * from work.NIS_1997_CMDCCHPR1;

proc SQL;
create table isilon.NIS_1997_CMPCCHPR1
like work.NIS_1997_CMPCCHPR1;

proc SQL;
insert into isilon.NIS_1997_CMPCCHPR1
select * from work.NIS_1997_CMPCCHPR1;




proc delete data= work.NIS_1997_A; run;
proc delete data= work.NIS_1997_B; run;
proc delete data= work.NIS_1997_C; run;
proc delete data= work.NIS_1997_DX; run;
proc delete data= work.NIS_1997_PR; run;
proc delete data= work.NIS_1997_WT; run;
proc delete data= work.NIS_1997_CMPCCHPR1; run;
proc delete data= work.NIS_1997_CMDCCHPR1; run;
proc delete data= work.NIS_1997_CMDRG; run;
