...
*******************************;                                                
DATA NIS_1999_CORE;    
INFILE "%trim(&filepath)NIS/NIS_1999/Data/NIS_1999_CORE.asc" lrecl=484;                                        
...
*  Data Step                  *;                                                
*******************************;                                                
DATA NIS_1999_CORE10A;                                                          
INFILE "%trim(&filepath)NIS/NIS_1999/Data/NIS_1999_CORE10A.ASC" LRECL = 484;                                      
...
*  Data Step                  *;                                                
*******************************;                                                
DATA NIS_1999_CORE10B;                                                          
INFILE "%trim(&filepath)NIS/NIS_1999/Data/NIS_1999_CORE10B.ASC" LRECL = 484;                                      
...
*  Data Step                  *;                                                
*******************************;                                                
DATA NIS_1999_HOSPITAL;                                                         
INFILE "%trim(&filepath)NIS/NIS_1999/Data/NIS_1999_HOSPITAL.ASC" LRECL = 173;                                     
...
RUN;
proc SQL;
create table isilon.NIS_1999_CORE
like work.NIS_1999_CORE;

proc SQL;
insert into isilon.NIS_1999_CORE
select * from work.NIS_1999_CORE;

proc SQL;
create table isilon.NIS_1999_CORE10A
like work.NIS_1999_CORE10A;

proc SQL;
insert into isilon.NIS_1999_CORE10A
select * from work.NIS_1999_CORE10A;

proc SQL;
create table isilon.NIS_1999_CORE10B
like work.NIS_1999_CORE10B;

proc SQL;
insert into isilon.NIS_1999_CORE10B
select * from work.NIS_1999_CORE10B;

proc SQL;
create table isilon.NIS_1999_HOSPITAL
like work.NIS_1999_HOSPITAL;

proc SQL;
insert into isilon.NIS_1999_HOSPITAL
select * from work.NIS_1999_HOSPITAL;

proc delete data= work.NIS_1999_CORE; run;
proc delete data= work.NIS_1999_CORE10A; run;
proc delete data= work.NIS_1999_CORE10B; run;
proc delete data= work.NIS_1999_HOSPITAL; run;