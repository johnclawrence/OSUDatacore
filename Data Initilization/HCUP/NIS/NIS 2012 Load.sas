...
* "%trim(&filepath)NIS/NIS_2012/Data/NIS_2012   *;  
...
/*****************************************************************************
* SASload_NIS_2012_Severity.SAS
* This program will load the 2012 NIS ASCII Severity File into SAS.
*****************************************************************************/
...
DATA NIS_2012_Severity; 
INFILE "%trim(&filepath)NIS/NIS_2012/Data/NIS_2012_Severity.asc" LRECL = 81;
...
RUN;
/*****************************************************************************
* SASload_NIS_2012_Core.SAS
* This program will load the 2012 NIS ASCII Core File into SAS.
*****************************************************************************/
...
*** Data Step to load the file ***;
DATA NIS_2012_Core; 
INFILE "%trim(&filepath)NIS/NIS_2012/Data/NIS_2012_Core.asc" LRECL = 504;
...
RUN;
/*****************************************************************************
* SASload_NIS_2012_DX_PR_GRPS.SAS
* This program will load the 2012 NIS ASCII DX_PR_GRPS File into SAS.
*****************************************************************************/
...
*** Data Step to load the file ***;
DATA NIS_2012_DX_PR_GRPS; 
INFILE "%trim(&filepath)NIS/NIS_2012/Data/NIS_2012_DX_PR_GRPS.asc" LRECL = 240;
...
RUN;
/*****************************************************************************
* SASload_NIS_2012_Hospital.SAS
* This program will load the 2012 NIS ASCII Hospital File into SAS.
*****************************************************************************/
...
*** Data Step to load the file ***;
DATA NIS_2012_Hospital; 
INFILE "%trim(&filepath)NIS/NIS_2012/Data/NIS_2012_Hospital.asc" LRECL = 64;
...
proc SQL;
create table isilon.NIS_2012_HOSPITAL
like work.NIS_2012_HOSPITAL;

proc SQL;
insert into isilon.NIS_2012_HOSPITAL
select * from work.NIS_2012_HOSPITAL;

proc SQL;
create table isilon.NIS_2012_CORE
like work.NIS_2012_CORE;

proc SQL;
insert into isilon.NIS_2012_CORE
select * from work.NIS_2012_CORE;

proc SQL;
create table isilon.NIS_2012_Dx_Pr_Grps
like work.NIS_2012_Dx_Pr_Grps;

proc SQL;
insert into isilon.NIS_2012_Dx_Pr_Grps
select * from work.NIS_2012_Dx_Pr_Grps;

proc SQL;
create table isilon.NIS_2012_SEVERITY
like work.NIS_2012_SEVERITY;

proc SQL;
insert into isilon.NIS_2012_SEVERITY
select * from work.NIS_2012_SEVERITY;



proc delete data= work.NIS_2012_HOSPITAL; run;
proc delete data= work.NIS_2012_CORE; run;
proc delete data= work.NIS_2012_Dx_Pr_Grps; run;
proc delete data= work.NIS_2012_SEVERITY; run;