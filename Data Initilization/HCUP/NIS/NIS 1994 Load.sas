...
*                 THE ASCII NIS, RELEASE 3, INPATIENT      ;
...
***********************************************;
DATA NIS_1994_A ;
  INFILE "%trim(&filepath)NIS/NIS_1994/Data/NIS94_A.ASC" LRECL=95;
...
***********************************************;
DATA NIS_1994_B ;
  INFILE "%trim(&filepath)NIS/NIS_1994/Data/NIS94_B.ASC" LRECL=91;
...
***********************************************;
DATA NIS_1994_C ;
  INFILE "%trim(&filepath)NIS/NIS_1994/Data/NIS94_C.ASC" LRECL=65;
...
*                  THE ASCII NIS, RELEASE 3, CORE FILE DX  ;
*                  (DIAGNOSES) TO SAS.                     ;
*                                                          ;
***********************************************************;
...
***********************************************;
DATA NIS_1994_DX ;
  INFILE "%trim(&filepath)NIS/NIS_1994/Data/NIS94_DX.ASC" LRECL=20;
...
*                  THE ASCII NIS, RELEASE 3, CORE FILE PR  ;
*                  (PROCEDURES) TO SAS.                    ;
*                                                          ;
***********************************************************;
...
***********************************************;
DATA NIS_1994_PR ;
  INFILE "%trim(&filepath)NIS/NIS_1994/Data/NIS94_PR.ASC" LRECL=19;
...
*                   THE ASCII NIS, RELEASE 3, CASEMIX COUNTS ;
...
*  Data step                                   ;
***********************************************;
DATA NIS_1994_CMDCCHPR1 ;
  INFILE "%trim(&filepath)NIS/NIS_1994/Data/N94_HDC1.ASC" LRECL=46;
...
***********************************************;
DATA NIS_1994_CMDRG ;
  INFILE "%trim(&filepath)NIS/NIS_1994/Data/N94_HDRG.ASC" LRECL=46;
...
*  Data step                                   ;
***********************************************;
DATA NIS_1994_CMPCCHPR1 ;
  INFILE "%trim(&filepath)NIS/NIS_1994/Data/N94_HPC1.ASC" LRECL=46;
...
*                 THE ASCII NIS, RELEASE 3, HOSPITAL       ;
*                 WEIGHTS FILE TO SAS.                     ;
*                                                          ;
***********************************************************;
...
DATA NIS_1994_WT ;
  INFILE "%trim(&filepath)NIS/NIS_1994/Data/NIS94WT.ASC" LRECL=251;
...
proc SQL;
create table isilon.NIS_1994_C
like work.NIS_1994_C;

proc SQL;
insert into isilon.NIS_1994_C
select * from work.NIS_1994_C;

proc SQL;
create table isilon.NIS_1994_B
like work.NIS_1994_B;

proc SQL;
insert into isilon.NIS_1994_B
select * from work.NIS_1994_B;

proc SQL;
create table isilon.NIS_1994_A
like work.NIS_1994_A;

proc SQL;
insert into isilon.NIS_1994_A
select * from work.NIS_1994_A;

proc SQL;
create table isilon.NIS_1994_PR
like work.NIS_1994_PR;

proc SQL;
insert into isilon.NIS_1994_PR
select * from work.NIS_1994_PR;

proc SQL;
create table isilon.NIS_1994_DX
like work.NIS_1994_DX;

proc SQL;
insert into isilon.NIS_1994_DX
select * from work.NIS_1994_DX;

proc SQL;
create table isilon.NIS_1994_WT
like work.NIS_1994_WT;

proc SQL;
insert into isilon.NIS_1994_WT
select * from work.NIS_1994_WT;

proc SQL;
create table isilon.NIS_1994_CMDRG
like work.NIS_1994_CMDRG;

proc SQL;
insert into isilon.NIS_1994_CMDRG
select * from work.NIS_1994_CMDRG;

proc SQL;
create table isilon.NIS_1994_CMDCCHPR1
like work.NIS_1994_CMDCCHPR1;

proc SQL;
insert into isilon.NIS_1994_CMDCCHPR1
select * from work.NIS_1994_CMDCCHPR1;

proc SQL;
create table isilon.NIS_1994_CMPCCHPR1
like work.NIS_1994_CMPCCHPR1;

proc SQL;
insert into isilon.NIS_1994_CMPCCHPR1
select * from work.NIS_1994_CMPCCHPR1;




proc delete data= work.NIS_1994_A; run;
proc delete data= work.NIS_1994_B; run;
proc delete data= work.NIS_1994_C; run;
proc delete data= work.NIS_1994_DX; run;
proc delete data= work.NIS_1994_PR; run;
proc delete data= work.NIS_1994_WT; run;
proc delete data= work.NIS_1994_CMPCCHPR1; run;
proc delete data= work.NIS_1994_CMDCCHPR1; run;
proc delete data= work.NIS_1994_CMDRG; run;