...
DATA NIS_1996_WT;
  INFILE "%trim(&filepath)NIS/NIS_1996/Data/NIS96WT.ASC" LRECL=251;
...
***********************************************;
DATA NIS_1996_A;
  INFILE "%trim(&filepath)NIS/NIS_1996/Data/NIS96_A.ASC" LRECL=95;
...
***********************************************;
DATA NIS_1996_B;
  INFILE "%trim(&filepath)NIS/NIS_1996/Data/NIS96_B.ASC" LRECL=91;
...
***********************************************;
DATA NIS_1996_C;
  INFILE "%trim(&filepath)NIS/NIS_1996/Data/NIS96_C.ASC" LRECL=65;
...
***********************************************;
DATA NIS_1996_DX;
  INFILE "%trim(&filepath)NIS/NIS_1996/Data/NIS96_DX.ASC" LRECL=20;
...
***********************************************;
DATA NIS_1996_PR;
  INFILE "%trim(&filepath)NIS/NIS_1996/Data/NIS96_PR.ASC" LRECL=19;
...
*  Data step                                   ;
***********************************************;
DATA NIS_1996_CMDCCHPR1;
  INFILE "%trim(&filepath)NIS/NIS_1996/Data/N96_HDC1.ASC" LRECL=46;
...
***********************************************;
DATA NIS_1996_CMDRG;
  INFILE "%trim(&filepath)NIS/NIS_1996/Data/N96_HDRG.ASC" LRECL=46;
...
*  Data step                                   ;
***********************************************;
DATA NIS_1996_CMPCCHPR1;
  INFILE "%trim(&filepath)NIS/NIS_1996/Data/N96_HPC1.ASC" LRECL=46;
...
proc SQL;
create table isilon.NIS_1996_C
like work.NIS_1996_C;

proc SQL;
insert into isilon.NIS_1996_C
select * from work.NIS_1996_C;

proc SQL;
create table isilon.NIS_1996_B
like work.NIS_1996_B;

proc SQL;
insert into isilon.NIS_1996_B
select * from work.NIS_1996_B;

proc SQL;
create table isilon.NIS_1996_A
like work.NIS_1996_A;

proc SQL;
insert into isilon.NIS_1996_A
select * from work.NIS_1996_A;

proc SQL;
create table isilon.NIS_1996_PR
like work.NIS_1996_PR;

proc SQL;
insert into isilon.NIS_1996_PR
select * from work.NIS_1996_PR;

proc SQL;
create table isilon.NIS_1996_DX
like work.NIS_1996_DX;

proc SQL;
insert into isilon.NIS_1996_DX
select * from work.NIS_1996_DX;

proc SQL;
create table isilon.NIS_1996_WT
like work.NIS_1996_WT;

proc SQL;
insert into isilon.NIS_1996_WT
select * from work.NIS_1996_WT;

proc SQL;
create table isilon.NIS_1996_CMDRG
like work.NIS_1996_CMDRG;

proc SQL;
insert into isilon.NIS_1996_CMDRG
select * from work.NIS_1996_CMDRG;

proc SQL;
create table isilon.NIS_1996_CMDCCHPR1
like work.NIS_1996_CMDCCHPR1;

proc SQL;
insert into isilon.NIS_1996_CMDCCHPR1
select * from work.NIS_1996_CMDCCHPR1;

proc SQL;
create table isilon.NIS_1996_CMPCCHPR1
like work.NIS_1996_CMPCCHPR1;

proc SQL;
insert into isilon.NIS_1996_CMPCCHPR1
select * from work.NIS_1996_CMPCCHPR1;




proc delete data= work.NIS_1996_A; run;
proc delete data= work.NIS_1996_B; run;
proc delete data= work.NIS_1996_C; run;
proc delete data= work.NIS_1996_DX; run;
proc delete data= work.NIS_1996_PR; run;
proc delete data= work.NIS_1996_WT; run;
proc delete data= work.NIS_1996_CMPCCHPR1; run;
proc delete data= work.NIS_1996_CMDCCHPR1; run;
proc delete data= work.NIS_1996_CMDRG; run;