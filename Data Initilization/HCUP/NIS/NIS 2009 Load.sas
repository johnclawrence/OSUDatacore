...
* "%trim(&filepath)NIS/NIS_2009/Data/NIS_2009   *;  
...
/*****************************************************************************
* SASload_NIS_2009_Severity.SAS
* This program will load the 2009 NIS ASCII Severity File into SAS.
*****************************************************************************/
...
DATA NIS_2009_Severity; 
INFILE "%trim(&filepath)NIS/NIS_2009/Data/NIS_2009_Severity.asc" LRECL = 130;                                                                                                                                                                                                    
...
RUN;
/*****************************************************************************
* SASload_NIS_2009_Core.SAS
* This program will load the 2009 NIS ASCII Core File into SAS.
*****************************************************************************/
...
*** Data Step to load the file ***;
DATA NIS_2009_Core; 
INFILE "%trim(&filepath)NIS/NIS_2009/Data/NIS_2009_Core.asc" LRECL = 598;                                                                                                                                                                                                    
...
INPUT 
      ...
      @549    PRDAY14                  N3PF.
      @552    PRDAY15                  N3PF.
      @555    PointOfOriginUB04        $CHAR1.
      @556    PointOfOrigin_X          $CHAR8.
      @564    RACE                     N2PF.
      @566    TOTCHG                   N10PF.
      @576    TOTCHG_X                 N15P2F.
      @591    TRAN_IN                  N2PF.
      @593    YEAR                     N4PF.
      @597    ZIPINC_QRTL              N2PF.
      ;
RUN;
/*****************************************************************************
* SASload_NIS_2009_DX_PR_GRPS.SAS
* This program will load the 2009 NIS ASCII DX_PR_GRPS File into SAS.
*****************************************************************************/
...
*** Data Step to load the file ***;
DATA NIS_2009_DX_PR_GRPS; 
INFILE "%trim(&filepath)NIS/NIS_2009/Data/NIS_2009_DX_PR_GRPS.asc" LRECL = 244;                                                                                                                                                                                                    
...
RUN;
/*****************************************************************************
* SASload_NIS_2009_Hospital.SAS
* This program will load the 2009 NIS ASCII Hospital File into SAS.
*****************************************************************************/
...
*** Data Step to load the file ***;
DATA NIS_2009_Hospital; 
INFILE "%trim(&filepath)NIS/NIS_2009/Data/NIS_2009_Hospital.asc" LRECL = 299;                                                                                                                                                                                                    
...
proc SQL;
create table isilon.NIS_2009_HOSPITAL
like work.NIS_2009_HOSPITAL;

proc SQL;
insert into isilon.NIS_2009_HOSPITAL
select * from work.NIS_2009_HOSPITAL;

proc SQL;
create table isilon.NIS_2009_CORE
like work.NIS_2009_CORE;

proc SQL;
insert into isilon.NIS_2009_CORE
select * from work.NIS_2009_CORE;

proc SQL;
create table isilon.NIS_2009_Dx_Pr_Grps
like work.NIS_2009_Dx_Pr_Grps;

proc SQL;
insert into isilon.NIS_2009_Dx_Pr_Grps
select * from work.NIS_2009_Dx_Pr_Grps;

proc SQL;
create table isilon.NIS_2009_SEVERITY
like work.NIS_2009_SEVERITY;

proc SQL;
insert into isilon.NIS_2009_SEVERITY
select * from work.NIS_2009_SEVERITY;



proc delete data= work.NIS_2009_HOSPITAL; run;
proc delete data= work.NIS_2009_CORE; run;
proc delete data= work.NIS_2009_Dx_Pr_Grps; run;
proc delete data= work.NIS_2009_SEVERITY; run;