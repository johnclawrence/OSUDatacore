...
* "%trim(&filepath)NRD/NRD_2014/Data/NRD_2014   *;  
...
/*****************************************************************************
 * SASload_NRD_2014_Hospital.SAS
 * This program will load the 2014 NRD csv Hospital File into SAS.
 *****************************************************************************/
...
DATA NRD_2014_Hospital; 
INFILE "%trim(&filepath)NRD/NRD_2014/Data/NRD_2014_Hospital.csv" dsd dlm=',' LRECL = 66;
...
INFILE "%trim(&filepath)NRD/NRD_2014/Data/NRD_2014_DX_PR_GRPS.csv" dsd dlm=',' LRECL = 355;
...
/* Data Step to load the file */
DATA NRD_2014_Core; 
INFILE "%trim(&filepath)NRD/NRD_2014/Data/NRD_2014_Core.csv" dsd dlm=',' LRECL = 705;
...
RUN;
/*****************************************************************************
 * SASload_NRD_2014_Severity.SAS
 * This program will load the 2014 NRD csv Severity File into SAS.
 *****************************************************************************/
...
/* Data Step to load the file */
DATA NRD_2014_Severity; 
INFILE "%trim(&filepath)NRD/NRD_2014/Data/NRD_2014_Severity.csv" dsd dlm=',' LRECL = 120;
...
proc SQL;
create table isilon.NRD_2014_Core
like work.NRD_2014_Core;

proc SQL;
insert into isilon.NRD_2014_Core
select * from work.NRD_2014_Core;

proc SQL;
create table isilon.NRD_2014_DX_PR_GRPS
like work.NRD_2014_DX_PR_GRPS;

proc SQL;
insert into isilon.NRD_2014_DX_PR_GRPS
select * from work.NRD_2014_DX_PR_GRPS;

proc SQL;
create table isilon.NRD_2014_Hospital
like work.NRD_2014_Hospital;

proc SQL;
insert into isilon.NRD_2014_Hospital
select * from work.NRD_2014_Hospital;

proc SQL;
create table isilon.NRD_2014_Severity
like work.NRD_2014_Severity;

proc SQL;
insert into isilon.NRD_2014_Severity
select * from work.NRD_2014_Severity;




proc delete data= work.NRD_2014_Core; run;
proc delete data= work.NRD_2014_DX_PR_GRPS; run;
proc delete data= work.NRD_2014_Hospital; run;
proc delete data= work.NRD_2014_Severity; run;
