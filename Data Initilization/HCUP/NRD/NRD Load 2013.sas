...
/*****************************************************************************
 * SASload_NRD_2013_Severity.SAS
 * This program will load the 2013 NRD csv Severity File into SAS.
 *****************************************************************************/
...
DATA NRD_2013_Severity; 
INFILE "%trim(&filepath)NRD/NRD_2013/Data/NRD_2013_Severity.csv" dsd dlm=',' LRECL = 120;
...
RUN;
/*****************************************************************************
 * SASload_NRD_2013_Core.SAS
 * This program will load the 2013 NRD csv Core File into SAS.
 *****************************************************************************/
...
/* Data Step to load the file */
DATA NRD_2013_Core; 
INFILE "%trim(&filepath)NRD/NRD_2013/Data/NRD_2013_Core.csv" dsd dlm=',' LRECL = 591;
...
RUN;
/*****************************************************************************
 * SASload_NRD_2013_DX_PR_GRPS.SAS
 * This program will load the 2013 NRD csv DX_PR_GRPS File into SAS.
 *****************************************************************************/
...
/* Data Step to load the file */
DATA NRD_2013_DX_PR_GRPS; 
INFILE "%trim(&filepath)NRD/NRD_2013/Data/NRD_2013_DX_PR_GRPS.csv" dsd dlm=',' LRECL = 315;
...
INFILE "%trim(&filepath)NRD/NRD_2013/Data/NRD_2013_Hospital.csv" dsd dlm=',' LRECL = 66;
