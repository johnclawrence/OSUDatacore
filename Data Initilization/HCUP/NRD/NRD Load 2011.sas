...
* "%trim(&filepath)NRD/NRD_2011/Data/NRD_2011   *;  
...
/*****************************************************************************
 * SASload_NRD_2011_Hospital_V2.SAS
 * Created on 09/28/2017.
 * This program will load the 2011 NRD csv Hospital_V2 File into SAS.
 *****************************************************************************/
...
DATA NRD_2011_Hospital_V2; 
INFILE "%trim(&filepath)NRD/NRD_2011/Data/NRD_2011_Hospital_V2.csv" dsd dlm=',' LRECL = 66;
...
/*****************************************************************************
 * SASload_NRD_2011_Severity_V2.SAS
 * Created on 09/28/2017.
 * This program will load the 2011 NRD csv Severity_V2 File into SAS.
 *****************************************************************************/
...
/* Data Step to load the file */
DATA NRD_2011_Severity_V2; 
INFILE "%trim(&filepath)NRD/NRD_2011/Data/NRD_2011_Severity_V2.csv" dsd dlm=',' LRECL = 120;
...
RUN;
/*****************************************************************************
 * SASload_NRD_2011_Core_V2.SAS
 * Created on 09/28/2017.
 * This program will load the 2011 NRD csv Core_V2 File into SAS.
 *****************************************************************************/
...
/* Data Step to load the file */
DATA NRD_2011_Core_V2; 
INFILE "%trim(&filepath)NRD/NRD_2011/Data/NRD_2011_Core_V2.csv" dsd dlm=',' LRECL = 592;
...
RUN;
/*****************************************************************************
 * SASload_NRD_2011_DX_PR_GRPS_V2.SAS
 * Created on 09/28/2017.
 * This program will load the 2011 NRD csv DX_PR_GRPS_V2 File into SAS.
 *****************************************************************************/
...
/* Data Step to load the file */
DATA NRD_2011_DX_PR_GRPS_V2; 
INFILE "%trim(&filepath)NRD/NRD_2011/Data/NRD_2011_DX_PR_GRPS_V2.csv" dsd dlm=',' LRECL = 315;
...
proc SQL;
create table isilon.NRD_2011_Core_V2
like work.NRD_2011_Core_V2;

proc SQL;
insert into isilon.NRD_2011_Core_V2
select * from work.NRD_2011_Core_V2;

proc SQL;
create table isilon.NRD_2011_DX_PR_GRPS_V2
like work.NRD_2011_DX_PR_GRPS_V2;

proc SQL;
insert into isilon.NRD_2011_DX_PR_GRPS_V2
select * from work.NRD_2011_DX_PR_GRPS_V2;

proc SQL;
create table isilon.NRD_2011_Hospital_V2
like work.NRD_2011_Hospital_V2;

proc SQL;
insert into isilon.NRD_2011_Hospital_V2
select * from work.NRD_2011_Hospital_V2;

proc SQL;
create table isilon.NRD_2011_Severity_V2
like work.NRD_2011_Severity_V2;

proc SQL;
insert into isilon.NRD_2011_Severity_V2
select * from work.NRD_2011_Severity_V2;




proc delete data= work.NRD_2011_Core_V2; run;
proc delete data= work.NRD_2011_DX_PR_GRPS_V2; run;
proc delete data= work.NRD_2011_Hospital_V2; run;
proc delete data= work.NRD_2011_Severity_V2; run;
