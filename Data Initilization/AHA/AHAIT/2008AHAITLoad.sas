...
PROC Import
	DATAFILE = "X:\AHA\AHAIT Raw Data\2008_AHAIT\2008_AHAIT_Database - Load JL.xlsx"
	OUT= AHAIT2008
	DBMS=xlsx
	Replace;
	Sheet="Sheet1";
...
proc SQL;
create table isilon.AHAIT2008
like work.AHAIT2008;

proc SQL;
insert into isilon.AHAIT2008
select * from work.AHAIT2008;
