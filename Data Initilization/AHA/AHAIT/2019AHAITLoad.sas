...
PROC Import
	DATAFILE = "X:\AHA\AHAIT Raw Data\2019_AHAIT\AHA_2019_Healthcare_IT_Database - Load JL.xlsx"
	OUT= AHAIT2019
	DBMS=xlsx
	Replace;
	Sheet="2019 AHA IT DATA";
	GETNAMES = YES;
Run;
...
proc SQL;
create table isilon.AHAIT2019
like work.AHAIT2019;

proc SQL;
insert into isilon.AHAIT2019
select * from work.AHAIT2019;
