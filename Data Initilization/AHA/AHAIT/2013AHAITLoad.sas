...
PROC Import
	DATAFILE = "X:\AHA\AHAIT Raw Data\2013_AHAIT\2013_AHAIT_Database - Load JL.xlsx"
	OUT= AHAIT2013
	DBMS=xlsx
	Replace;
	Sheet="2013 AHA IT - Field Label ver";
	GETNAMES = YES;
Run;
...
proc SQL;
create table isilon.AHAIT2013
like work.AHAIT2013;

proc SQL;
insert into isilon.AHAIT2013
select * from work.AHAIT2013;
