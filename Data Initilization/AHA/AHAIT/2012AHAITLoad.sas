...
PROC Import
	DATAFILE = "X:\AHA\AHAIT Raw Data\2012_AHAIT\2012_AHAIT_Database_Corrected - Load JL.xlsx"
	OUT= AHAIT2012
	DBMS=xlsx
	Replace;
	Sheet="Data";
...
proc SQL;
create table isilon.AHAIT2012
like work.AHAIT2012;

proc SQL;
insert into isilon.AHAIT2012
select * from work.AHAIT2012;
