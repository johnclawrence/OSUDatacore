...
PROC Import
	DATAFILE = "X:\AHA\AHAIT Raw Data\2016_AHAIT\2016_AHAIT_Database - Load JL.xlsx"
	OUT= AHAIT2016
	DBMS=xlsx
	Replace;
	Sheet="Sheet1";
...
proc SQL;
create table isilon.AHAIT2016
like work.AHAIT2016;

proc SQL;
insert into isilon.AHAIT2016
select * from work.AHAIT2016;
